...
public class GetUsuarioIdentificacaoViewModel {
    ...
    public GetUsuarioIdentificacaoViewModel(UUID id, long numero, IdentificacaoTipo tipo, Situacao situacao, ViewModelWithIdAndNome curso)
    {
        this.id = id;
        this.numero = numero;
        this.tipo = tipo;
